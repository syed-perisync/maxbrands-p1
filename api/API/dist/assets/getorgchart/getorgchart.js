...
var getOrgChartW;
_getOrgChart = function getOrgChart(b, a) {
    this.config = {
        theme: "ula",
        color: "blue",
        enableEdit: true,
        ...
        scale: "auto",
        linkType: "M",
        orientation: _getOrgChart.RO_TOP,
    ...
    var d = _getOrgChart.util._7("colorScheme");
    if (d) {
        this.config.color = d;
    }
    if (a) {
    ...
    this._d();
    this.version = "2.5.3";
    this.theme = _getOrgChart.themes[this.config.theme];
    this.element = b;
    this.nodes = {};
    this._aZ = [];
    this._aW = [];
    ...
    this._a2 = null;
    this._ai = [];
    this._zu = new _getOrgChart.node(-1, null, null, null, 2, 2);
    this._zA = {
        found: [],
        showIndex: 0,
        oldValue: "",
    ...
    for (id in this.config.customize) {
        if (this.config.customize[id].theme) {
            this.config.embededDefinitions += _getOrgChart.themes[this.config.customize[id].theme].defs;
        }
    }
    this._X = new _getOrgChart._X(this.element);
    this._ad();
    this.load();
};
_getOrgChart.prototype._ad = function () {
    this._f();
    var a = _getOrgChart.INNER_HTML.replace("[theme]", this.config.theme).replace("[color]", this.config.color).replace(/\[height]/g, this._a9).replace(/\[toolbar-height]/g, this.theme.toolbarHeight);
...
_getOrgChart.prototype.changeColorScheme = function (a) {
...
_getOrgChart.prototype._zs = function () {
    this._aZ = [];
    this._aW = [];
    this._zv = [];
    _getOrgChart._T(this, this._zu, 0);
    _getOrgChart._zX(this, this._zu, 0, 0, 0);
    _getOrgChart._zH(this);
};
_getOrgChart.prototype._zC = function (b, a) {
    if (this._aZ[a] == null) {
        this._aZ[a] = 0;
    }
    if (this._aZ[a] < b.h) {
...
_getOrgChart.prototype._zR = function (b, a) {
    if (this._aW[a] == null) {
        this._aW[a] = 0;
    }
    if (this._aW[a] < b.w) {
...
_getOrgChart.prototype._zF = function (b, a) {
...
_getOrgChart.prototype._3 = function (a) {
    switch (this.config.orientation) {
        case _getOrgChart.RO_TOP:
        case _getOrgChart.RO_TOP_PARENT_LEFT:
        case _getOrgChart.RO_BOTTOM:
        case _getOrgChart.RO_BOTTOM_PARENT_LEFT:
            return a.w;
        case _getOrgChart.RO_RIGHT:
        case _getOrgChart.RO_RIGHT_PARENT_TOP:
        case _getOrgChart.RO_LEFT:
        case _getOrgChart.RO_LEFT_PARENT_TOP:
            return a.h;
    }
    return 0;
};
_getOrgChart.prototype._1 = function (g, d, e) {
    if (d >= e) {
        return g;
    }
    if (g._N() == 0) {
...
_getOrgChart.prototype._A = function () {
    var f = [];
    var h;
    if (this._X._v) {
        h = _getOrgChart.util._8(this._X);
    } else {
        h = this._9();
    }
    f.push(_getOrgChart.OPEN_SVG.replace("[defs]", this.config.embededDefinitions).replace("[viewBox]", h.toString()));
    ...
    f.push(_getOrgChart.buttons.draw());
    f.push(_getOrgChart.CLOSE_SVG);
    var a = f.join("");
    return a;
};
_getOrgChart.prototype._r = function (a, i, c, b, g, h) {
    var d = a;
    var f = null;
    if (i) {
...
_getOrgChart.prototype._9 = function () {
    ...
    switch (this.config.orientation) {
        ...
        case _getOrgChart.RO_TOP_PARENT_LEFT:
            ...
            if (this.scale === "auto") {
                ...
                if (this.config.orientation == _getOrgChart.RO_TOP) {
                    a = c.x - o / 2 + c.w / 2;
                }
            }
        ...
        case _getOrgChart.RO_BOTTOM_PARENT_LEFT:
            ...
            if (this.scale === "auto") {
                ...
                o = this._a0 / this.scale;
                d = this._a9 / this.scale;
                if (this.config.orientation == _getOrgChart.RO_BOTTOM) {
                    a = c.x - o / 2 + c.w / 2;
                }
            }
        ...
        case _getOrgChart.RO_RIGHT_PARENT_TOP:
            ...
            if (this.scale === "auto") {
                ...
                o = this._a0 / this.scale;
                d = this._a9 / this.scale;
                if (this.orientation == _getOrgChart.RO_RIGHT) {
                    b = c.y - d / 2 + c.h / 2;
                }
            }
        ...
        case _getOrgChart.RO_LEFT_PARENT_TOP:
            ...
            if (this.scale === "auto") {
                ...
                o = this._a0 / this.scale;
                d = this._a9 / this.scale;
                if (this.config.orientation == _getOrgChart.RO_LEFT) {
                    b = c.y - d / 2 + c.h / 2;
                }
            }
...
_getOrgChart.prototype.draw = function (a) {
    this._X._zd();
    this._zs();
...
_getOrgChart.prototype._z = function (a) {
    var g = [];
...
_getOrgChart.prototype._aR = function (c, b) {
...
_getOrgChart.prototype._aF = function (b, a) {
    this._zy(b, "mouseup", this._aF);
    this._zy(b, "mouseleave", this._aF);
    clearInterval(b.interval);
};
_getOrgChart.prototype.move = function (f, a, b) {
    var h = _getOrgChart.util._8(this._X);
    var e = h.slice(0);
...
_getOrgChart.prototype.isCollapsed = function (a) {
    if (a.parent == this._zu || a.parent == null) {
        return false;
    }
    if (a.parent.collapsed != _getOrgChart.EXPANDED) {
        return true;
    } else {
...
_getOrgChart.prototype._e = function () {
    if (this.config.enableGridView) {
...
_getOrgChart.prototype._q = function (b, c, d, e) {
    if (!e) {
        e = "";
    }
...
_getOrgChart.prototype._zy = function (a, b) {
...
_getOrgChart.prototype._z1 = function (b, a) {
    if (!this._E) {
        this._E = {};
    }
    if (!this._E[b]) {
...
_getOrgChart.prototype._d = function () {
...
_getOrgChart.prototype._V = function (b, a) {
    if (!this._E) {
        return true;
    }
    if (!this._E[b]) {
...
_getOrgChart._X = function (a) {
    this.element = a;
    this._n;
};
_getOrgChart._X.prototype._zd = function () {
...
_getOrgChart._X.prototype._ze = function () {
...
_getOrgChart._X.prototype._zk = function (a) {
    this._t.style.overflow = "auto";
    this._v.style.width = a + "px";
};
_getOrgChart._X.prototype._I = function () {
    return this._i.querySelectorAll('input[type="hidden"]')[0];
};
_getOrgChart._X.prototype._J = function () {
...
_getOrgChart._X.prototype._K = function () {
    return this._i.querySelectorAll('input[type="text"]');
};
_getOrgChart._X.prototype._U = function () {
    return this._i.querySelector('input[type="file"]');
};
_getOrgChart._X.prototype._M = function () {
...
_getOrgChart._X.prototype._O = function () {
    var a = this._i.getElementsByTagName("select");
    for (i = 0; i < a.length; i++) {
...
_getOrgChart._X.prototype.getNodeById = function (a) {
    return this._zw.querySelector("[data-node-id='" + a + "']");
};
_getOrgChart._X.prototype.removeLinks = function () {
...
_getOrgChart._X.prototype.getButtonByType = function (a) {
    return this._zw.querySelector("[data-btn-action='" + a + "']");
};
_getOrgChart._X.prototype._zI = function (a) {
    var c;
    if (!a) {
        c = this._zY;
    } else {
...
_getOrgChart.SCALE_FACTOR = 1.2;
_getOrgChart.INNER_HTML = '<div class="get-[theme] get-[color] get-org-chart"><div class="get-oc-tb"><div><div style="height:[toolbar-height]px;"><input placeholder="Search" type="text" /><a title="previous" class="get-prev get-disabled" href="javascript:void(0)">&nbsp;</a><a title="next" class="get-next get-disabled" href="javascript:void(0)">&nbsp;</a><a class="get-minus" title="zoom out" href="javascript:void(0)">&nbsp;</a><a class="get-plus" title="zoom in" href="javascript:void(0)">&nbsp;</a><a href="javascript:void(0)" class="get-grid-view" title="grid view">&nbsp;</a><a href="javascript:void(0)" class="get-print" title="print">&nbsp;</a><a href="javascript:void(0)" class="get-export-to-image" title="export to image">&nbsp;</a></div ><div style="height:[toolbar-height]px;"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;</a></div><div style="height:[toolbar-height]px;"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;</a></div></div></div><div class="get-oc-c" style="height:[height]px;"></div><div class="get-oc-v" style="height:[height]px;"><div class="get-image-pane"></div><div class="get-data-pane"></div></div><div class="get-oc-g" style="height:[height]px;"></div><div class="get-left"><div class="get-left-icon"></div></div><div class="get-right"><div class="get-right-icon"></div></div><div class="get-up"><div class="get-up-icon"></div></div><div class="get-down"><div class="get-down-icon"></div></div></div>';
_getOrgChart.DETAILS_VIEW_INPUT_HTML = '<div data-field-name="[label]"><div class="get-label">[label]</div><div class="get-data"><input type="text" value="[value]"/>[file]</div></div>';
_getOrgChart.DETAILS_VIEW_USER_LOGO = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  xmlns:xml="http://www.w3.org/XML/1998/namespace" viewBox="0 0 50 50" class="get-user-logo" preserveAspectRatio="xMaxYMin meet"><g><path class="get-user-logo" d="M258.744,293.214c70.895,0,128.365-57.472,128.365-128.366c0-70.896-57.473-128.367-128.365-128.367 c-70.896,0-128.368,57.472-128.368,128.367C130.377,235.742,187.848,293.214,258.744,293.214z"/><path d="M371.533,322.432H140.467c-77.577,0-140.466,62.909-140.466,140.487v12.601h512v-12.601   C512,385.341,449.112,322.432,371.533,322.432z"/></g></svg>';
_getOrgChart.DETAILS_VIEW_USER_LOGO = '<svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 482.9 482.9" style="enable-background:new 0 0 482.9 482.9;" xml:space="preserve" class="get-user-logo">    <path d="M239.7,260.2c0.5,0,1,0,1.6,0c0.2,0,0.4,0,0.6,0c0.3,0,0.7,0,1,0c29.3-0.5,53-10.8,70.5-30.5 c38.5-43.4,32.1-117.8,31.4-124.9c-2.5-53.3-27.7-78.8-48.5-90.7C280.8,5.2,262.7,0.4,242.5,0h-0.7c-0.1,0-0.3,0-0.4,0h-0.6 c-11.1,0-32.9,1.8-53.8,13.7c-21,11.9-46.6,37.4-49.1,91.1c-0.7,7.1-7.1,81.5,31.4,124.9C186.7,249.4,210.4,259.7,239.7,260.2z M164.6,107.3c0-0.3,0.1-0.6,0.1-0.8c3.3-71.7,54.2-79.4,76-79.4h0.4c0.2,0,0.5,0,0.8,0c27,0.6,72.9,11.6,76,79.4 c0,0.3,0,0.6,0.1,0.8c0.1,0.7,7.1,68.7-24.7,104.5c-12.6,14.2-29.4,21.2-51.5,21.4c-0.2,0-0.3,0-0.5,0l0,0c-0.2,0-0.3,0-0.5,0 c-22-0.2-38.9-7.2-51.4-21.4C157.7,176.2,164.5,107.9,164.6,107.3z"/> <path d="M446.8,383.6c0-0.1,0-0.2,0-0.3c0-0.8-0.1-1.6-0.1-2.5c-0.6-19.8-1.9-66.1-45.3-80.9c-0.3-0.1-0.7-0.2-1-0.3 c-45.1-11.5-82.6-37.5-83-37.8c-6.1-4.3-14.5-2.8-18.8,3.3c-4.3,6.1-2.8,14.5,3.3,18.8c1.7,1.2,41.5,28.9,91.3,41.7 c23.3,8.3,25.9,33.2,26.6,56c0,0.9,0,1.7,0.1,2.5c0.1,9-0.5,22.9-2.1,30.9c-16.2,9.2-79.7,41-176.3,41 c-96.2,0-160.1-31.9-176.4-41.1c-1.6-8-2.3-21.9-2.1-30.9c0-0.8,0.1-1.6,0.1-2.5c0.7-22.8,3.3-47.7,26.6-56 c49.8-12.8,89.6-40.6,91.3-41.7c6.1-4.3,7.6-12.7,3.3-18.8c-4.3-6.1-12.7-7.6-18.8-3.3c-0.4,0.3-37.7,26.3-83,37.8 c-0.4,0.1-0.7,0.2-1,0.3c-43.4,14.9-44.7,61.2-45.3,80.9c0,0.9,0,1.7-0.1,2.5c0,0.1,0,0.2,0,0.3c-0.1,5.2-0.2,31.9,5.1,45.3 c1,2.6,2.8,4.8,5.2,6.3c3,2,74.9,47.8,195.2,47.8s192.2-45.9,195.2-47.8c2.3-1.5,4.2-3.7,5.2-6.3 C447,415.5,446.9,388.8,446.8,383.6z"/> </svg>';
_getOrgChart.DETAILS_VIEW_ID_INPUT = '<input value="[personId]" type="hidden"></input>';
_getOrgChart.DETAILS_VIEW_ID_IMAGE = '<img src="[src]"  />';
_getOrgChart.HIGHLIGHT_SCALE_FACTOR = 1.2;
_getOrgChart.MOVE_FACTOR = 2;
_getOrgChart.RO_TOP = 0;
_getOrgChart.RO_BOTTOM = 1;
_getOrgChart.RO_RIGHT = 2;
_getOrgChart.RO_LEFT = 3;
_getOrgChart.RO_TOP_PARENT_LEFT = 4;
_getOrgChart.RO_BOTTOM_PARENT_LEFT = 5;
_getOrgChart.RO_RIGHT_PARENT_TOP = 6;
_getOrgChart.RO_LEFT_PARENT_TOP = 7;
_getOrgChart.OPEN_SVG = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="[viewBox]"><defs>[defs]</defs><g>';
_getOrgChart.CLOSE_SVG = "</svg>";
_getOrgChart.OPEN_NODE = '<g data-node-id="[data-node-id]" class="get-level-[level] [nodeCssClass]" transform="matrix(1,0,0,1,[x],[y])">';
_getOrgChart.CLOSE_NODE = "</g>";
_getOrgChart.NOT_DEFINED = 0;
_getOrgChart.COLLAPSED = 1;
_getOrgChart.EXPANDED = 2;
_getOrgChart.MIXED_HIERARCHY_RIGHT_LINKS = 0;
_getOrgChart._T = function (h, g, d) {
    var c = null;
    g.x = 0;
    g.y = 0;
    g._zc = 0;
    ...
    h._zR(g, d);
    h._zF(g, d);
    if (g.collapsed == _getOrgChart.NOT_DEFINED) {
        g.collapsed = h.config.expandToLevel && h.config.expandToLevel <= d && g._N() ? _getOrgChart.COLLAPSED : _getOrgChart.EXPANDED;
    }
...
_getOrgChart._w = function (t, m, g) {
    var a = m._L();
...
_getOrgChart._zX = function (i, e, b, j, l) {
    if (b <= i.config.maxDepth) {
        ...
        if (e._N() != 0) {
            ...
            if (i.config.layout == _getOrgChart.MIXED_HIERARCHY_RIGHT_LINKS && e.children.length == 0) {
                c = i.config.separationMixedHierarchyNodes;
            }
            _getOrgChart._zX(i, e._L(), b + 1, j + e._aS, l + d + c);
        }
        var g = e._5();
        if (g != null) {
            _getOrgChart._zX(i, g, b, j, l);
        }
    }
};
_getOrgChart._zH = function (e) {
    e._zj = e._zu.x;
    e._zm = e._zu.y;
    if (e._a2) {
...
_getOrgChart.node = function (d, f, h, c, g, e, a, b) {
    this.id = d;
    this.pid = f;
    this.spid = h;
...
_getOrgChart.node.prototype._ay = function (a) {
    var b = this.parent;
    while (b != null) {
        if (b == a) {
            return true;
...
_getOrgChart.node.prototype.getParent = function () {
    if (this.displayParent != null) {
        return this.displayParent;
    }
    return this.parent;
};
_getOrgChart.node.prototype.getChildren = function () {
...
_getOrgChart.node.prototype.getImageUrl = function () {
    if (this.photoFields && this.data[this.photoFields[0]]) {
        return this.data[this.photoFields[0]];
    }
    return null;
};
_getOrgChart.node.prototype._N = function () {
    if (this.displayChildren == null && this.collapsed == _getOrgChart.COLLAPSED) {
        return 0;
    } else {
...
_getOrgChart.node.prototype._2 = function () {
...
_getOrgChart.node.prototype.isVisible = function () {
    if (this.x == 0 && this.y == 0) {
        return false;
    }
    return true;
};
_getOrgChart.node.prototype._5 = function () {
...
_getOrgChart.node.prototype._Y = function (a) {
    return this.getChildren()[a];
};
_getOrgChart.node.prototype._H = function (a) {
    node = this._L();
    node1 = this._P();
    return node._zc + (node1._zc - node._zc + a._3(node1)) / 2;
};
_getOrgChart.node.prototype._L = function () {
    return this._Y(0);
};
_getOrgChart.node.prototype._P = function () {
    return this._Y(this._N() - 1);
};
_getOrgChart.node.prototype._Z = function (a) {
    ...
    var f = 0,
        ...
        o = 0;
    var c = null;
    var e = a.customize[this.id] && a.customize[this.id].theme ? _getOrgChart.themes[a.customize[this.id].theme] : _getOrgChart.themes[a.theme];
    ...
    for (var b = 0; b < this.getChildren().length; b++) {
        ...
        if (this.displayChildren == null && c.displayChildren != null && this.collapsed == _getOrgChart.EXPANDED) {
            switch (a.orientation) {
                case _getOrgChart.RO_TOP:
                case _getOrgChart.RO_TOP_PARENT_LEFT:
                case _getOrgChart.RO_BOTTOM:
            ...
            if (this.displayChildren != null) {
                ...
                if (this.collapsed == _getOrgChart.EXPANDED) {
                    switch (a.linkType) {
                        case "M":
        ...
        if (a.expandToLevel && this.displayChildren == null) {
            d.push(_getOrgChart.buttons.expColl.replace("[display]", this.collapsed == _getOrgChart.EXPANDED ? "none" : "block").replace(/\[xa]/g, p - e.expandCollapseBtnRadius).replace(/\[ya]/g, u - e.expandCollapseBtnRadius).replace(/\[start]/g, e.expandCollapseBtnRadius * 2 / 6).replace(/\[middle]/g, e.expandCollapseBtnRadius).replace(/\[end]/g, e.expandCollapseBtnRadius * 2 / 6 * 5).replace(/\[id]/g, this.id));
        }
    }
    return d.join("");
};
_getOrgChart.node.prototype._W = function (c) {
    ...
    var j = 0,
        ...
        n = 0;
    var o = null;
    var q = c.customize[this.id] && c.customize[this.id].theme ? _getOrgChart.themes[c.customize[this.id].theme] : _getOrgChart.themes[c.theme];
...
_getOrgChart.node.prototype.isCollapsed = function () {
    if (this.parent == null) {
        return false;
    }
    if (this.parent.collapsed == _getOrgChart.COLLAPSED) {
        return true;
    } else {
...
_getOrgChart.node.prototype.getMostDeepChild = function (c) {
    var b = this;

    function a(f, g) {
        if (f.collapsed == _getOrgChart.EXPANDED || f.displayChildren != null) {
...
_getOrgChart.node.prototype.draw = function (a) {
    var h = [];
    var b = this.getImageUrl();
    var m = a.customize[this.id] && a.customize[this.id].theme ? _getOrgChart.themes[a.customize[this.id].theme] : _getOrgChart.themes[a.theme];
    ...
    h.push(_getOrgChart.OPEN_NODE.replace("[data-node-id]", this.id).replace("[x]", this._z2 == null ? this.x : this._z2).replace("[y]", this._z3 == null ? this.y : this._z3).replace("[level]", this.level).replace("[nodeCssClass]", d));
    ...
    h.push(_getOrgChart.CLOSE_NODE);
    return h;
};
if (!_getOrgChart) {
    var _getOrgChart = {};
...
get._z = function (a, c, b, h, i, d) {
    ...
    function f() {
        for (var s in b) {
            var t = _getOrgChart.util._s(["top", "left", "right", "bottom"], s.toLowerCase()) ? "px" : "";
...
_getOrgChart.buttons.draw = function () {
    var a = [];
    a.push(_getOrgChart.buttons.details);
    a.push(_getOrgChart.buttons.edit);
    a.push(_getOrgChart.buttons.add);
    a.push(_getOrgChart.buttons.del);
    return a;
};
if (typeof get == "undefined") {
    get = {};
...
_getOrgChart.util = {};
_getOrgChart.util._8 = function (a) {
...
_getOrgChart.util._6 = function (a) {
    var b = a.getAttribute("transform");
    b = b.replace("matrix", "").replace("(", "").replace(")", "");
    if (get._c().msie) {
        b = b.replace(/ /g, ",");
    }
    b = _getOrgChart.util._zM(b);
    b = "[" + b + "]";
    b = JSON.parse(b);
    return b;
};
_getOrgChart.util._zM = function (a) {
    return a.replace(/^\s+|\s+$/g, "");
};
_getOrgChart.util._s = function (a, c) {
...
_getOrgChart.util._G = function (b) {
    var a = "1";
    while (b[a]) {
        a++;
    }
...
_getOrgChart.util._7 = function (f) {
    var h = [],
        c;
...
_getOrgChart.util._zG = function (c) {
...
_getOrgChart.util._au = function (a) {
    if (a == null || typeof a == "undefined" || a == "" || a == -1) {
        return true;
    }
    return false;
};
_getOrgChart.util._ah = function (a) {
    return typeof a !== "undefined" && a !== null;
};
_getOrgChart.util._zq = function (b, a) {
...
_getOrgChart.util._zz = function (b, a) {
    var c = b.getBoundingClientRect();
...
_getOrgChart.util._aC = function (a, b, c) {
...
_getOrgChart.util._zJ = function (b, a) {
    var c = b.getBoundingClientRect();
    var d = a.touches[0].pageX - c.left;
    var f = a.touches[0].pageY - c.top;
    return Math.sqrt((d - t2x) * (d - t2x) + (f - t2y) * (f - t2y));
};
_getOrgChart.util._4 = function (a) {
...
_getOrgChart.util._ap = function (b, a) {
    var c = b.parent;
    if (a >= 0) {
        a++;
    } else {
    ...
    if (c) {
        return _getOrgChart.util._ap(c, a);
    } else {
        return a;
    }
};
...
_getOrgChart.prototype.showDetailsView = function (e) {
    var j = this.nodes[e];
    ...
    d += _getOrgChart.DETAILS_VIEW_ID_INPUT.replace("[personId]", j.id);
    for (label in j.data) {
        if (this.config.useFileUploader && _getOrgChart.util._s(this.config.photoFields, label)) {
            d += _getOrgChart.DETAILS_VIEW_INPUT_HTML.replace(/\[label]/g, label).replace("[file]", '<input type="file">').replace("[value]", j.data[label]);
        } else {
            d += _getOrgChart.DETAILS_VIEW_INPUT_HTML.replace(/\[label]/g, label).replace("[file]", "").replace("[value]", j.data[label]);
        }
        h.push(label);
    }
    d += a(h, this._ai);
        ...
        c.addEventListener("change", function () {
            ...
            k._V("changeFileInputEvent", {
                ...
                callback: function callback(n) {
                    m.value = n;
                    k._X._m.innerHTML = _getOrgChart.DETAILS_VIEW_ID_IMAGE.replace("[src]", n);
                }
            });
        });
    }
    ...
    if (f) {
        this._X._m.innerHTML = _getOrgChart.DETAILS_VIEW_ID_IMAGE.replace("[src]", f);
    } else {
        this._X._m.innerHTML = _getOrgChart.DETAILS_VIEW_USER_LOGO;
    }
    this._k();
    var l = this.config.customize[j.id] && this.config.customize[j.id].theme ? _getOrgChart.themes[this.config.customize[j.id].theme].toolbarHeight : this.theme.toolbarHeight;
...
_getOrgChart.prototype._k = function () {
    var a = this._X._K();
    if (this._X._M()) {
        this._q(this._X._M(), "change", this._j);
    }
};
_getOrgChart.prototype._j = function (m, a) {
    var n = this._X._J();
    var l = this._X._M();
    var k = l.value;
    ...
    var f = "";
    if (this.config.useFileUploader && _getOrgChart.util._s(this.config.photoFields, k)) {
        f = _getOrgChart.DETAILS_VIEW_INPUT_HTML.replace(/\[label]/g, k).replace("[file]", '<input type="file">').replace("[value]", "");
    } else {
        f = _getOrgChart.DETAILS_VIEW_INPUT_HTML.replace(/\[label]/g, k).replace("[file]", "").replace("[value]", "");
    }
        ...
        b.addEventListener("change", function () {
            ...
            o._V("changeFileInputEvent", {
                ...
                callback: function callback(p) {
                    j.value = p;
                    o._X._m.innerHTML = _getOrgChart.DETAILS_VIEW_ID_IMAGE.replace("[src]", p);
                }
            });
        });
    }
...
_getOrgChart.prototype._zi = function (e, a) {
    if (this._S) {
...
_getOrgChart.prototype._zV = function () {
    this.showGridView();
};
_getOrgChart.prototype.showGridView = function () {
...
_getOrgChart.prototype._zT = function (b, a) {
    this.showMainView();
};
_getOrgChart.prototype.showMainView = function () {
...
_getOrgChart.prototype._zg = function (b, a) {
    this.print();
};
_getOrgChart.prototype.print = function () {
    var b = this,
        d = this._X.element,
        k = this._X._zN,
        g = [],
...
_getOrgChart.prototype._z6 = function () {
    this.zoom(true, true);
};
_getOrgChart.prototype._z8 = function () {
    this.zoom(false, true);
};
_getOrgChart.prototype._zl = function (b, a) {
    this._zp = this._X._u.scrollTop + a[0].touches[0].pageY;
};
_getOrgChart.prototype._zo = function (b, a) {
    this._X._u.scrollTop = this._zp - a[0].touches[0].pageY;
};
_getOrgChart.prototype._zQ = function (d, b) {
    this._X._n = undefined;
    var a = b[0].wheelDelta ? b[0].wheelDelta / 40 : b[0].detail ? -b[0].detail : 0;
    if (a) {
        var e = a > 0;
        var c = _getOrgChart.util._aC(this._X._v, b[0].pageX, b[0].pageY);
        this.zoom(e, false, c);
    }
    return b[0].preventDefault() && false;
};
_getOrgChart.prototype._zh = function (b, a) {
    var c = this;
    window.setTimeout(function () {
        c.resize();
    }, 300);
};
_getOrgChart.prototype._aE = function (g, b) {
    this._X._n = undefined;
    if (this._a8.dragStart) {
        ...
        var j = _getOrgChart.util._8(this._X);
        var k = j[2] / this._a0;
        var c = j[3] / this._a9;
        var a = k > c ? k : c;
...
_getOrgChart.prototype._aX = function (b, a) {
    document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none";
    var c = _getOrgChart.util._8(this._X);
    this._a8.dragStart = {
...
_getOrgChart.prototype._aD = function (b, a) {
    this._a8.dragStart = null;
    this._X._t.style.cursor = "default";
};
_getOrgChart.prototype.zoom = function (c, a, b) {
    if (this._z4) {
        return false;
    }
    this._z4 = true;
    ...
    var g = j[3];
    if (c === true) {
        j[2] = j[2] / (_getOrgChart.SCALE_FACTOR * 1.2);
        j[3] = j[3] / (_getOrgChart.SCALE_FACTOR * 1.2);
    } else {
        if (c === false) {
            j[2] = j[2] * (_getOrgChart.SCALE_FACTOR * 1.2);
            j[3] = j[3] * (_getOrgChart.SCALE_FACTOR * 1.2);
...
_getOrgChart.prototype._aG = function (c, b) {
...
_getOrgChart.prototype._zf = function (c, b) {
    if (c.className.indexOf("get-disabled") > -1) {
        return false;
    }
    var a = this;
...
_getOrgChart.prototype._zW = function (c, b) {
    var a = this;
    clearTimeout(this._zA.timer);
    this._zA.timer = setTimeout(function () {
...
_getOrgChart.prototype._zS = function (c, b) {
    var a = this;
    clearTimeout(this._zA.timer);
    this._zA.timer = setTimeout(function () {
        a._zA.currentIndex = 0;
...
_getOrgChart.prototype._az = function () {
    if (this._zA.found.length) {
        this.highlightNode(this._zA.found[this._zA.currentIndex].node.id);
    }
};
_getOrgChart.prototype.highlightNode = function (c) {
    var a = this;

    function b() {
        var d = a.nodes[c];
        var e = _getOrgChart.util._8(a._X);
        ...
        a.move([f, g, a.initialViewBoxMatrix[2], a.initialViewBoxMatrix[3]], null, function () {
            ...
            var h = _getOrgChart.util._6(i);
            var j = h.slice(0);
            j[0] = _getOrgChart.HIGHLIGHT_SCALE_FACTOR;
            j[3] = _getOrgChart.HIGHLIGHT_SCALE_FACTOR;
            j[4] = j[4] - d.w / 2 * (_getOrgChart.HIGHLIGHT_SCALE_FACTOR - 1);
            j[5] = j[5] - d.h / 2 * (_getOrgChart.HIGHLIGHT_SCALE_FACTOR - 1);
            get._z(i, {
                transform: h
            }, {
                transform: j
...
_getOrgChart.prototype._am = function (a) {};
_getOrgChart.prototype._l = function () {
...
_getOrgChart.prototype._F = function (g) {
    var e = [];
    if (g == "") {
        return e;
    }
    ...
    for (var b in this.nodes) {
        ...
        for (m in f.data) {
            ...
            var c = -1;
            if (_getOrgChart.util._ah(f) && _getOrgChart.util._ah(f.data[m])) {
...
_getOrgChart.prototype._aK = function (g, a) {
    ...
    if (this.config.enableEdit == true || _getOrgChart.util._s(this.config.enableEdit, c)) {
        this._zD("add", f, b, c);
        this._zD("edit", d, h, c);
        this._zD("del", d, b, c);
    }
};
_getOrgChart.prototype._aI = function (i, c) {
    var b = c[0];
    b.preventDefault();
    this._aK(i, c);
    ...
    if (l < 400 && l > 0) {
        ...
        var g = this.nodes[d];
        var m = _getOrgChart.util._8(this._X);
        var f = m.slice(0);
        if (!this._aM.viewBox || this._aM.id != d) {
            var f = _getOrgChart.util._8(this._X);
            var a = f[2] / f[3];
            f[2] = g.w * 1.5;
            f[3] = f[2] / a;
            f[0] = g.x - g.w / 4;
...
_getOrgChart.prototype._aY = function (d, b) {
    b[0].preventDefault();
...
_getOrgChart.prototype.showEditView = function (a) {
    this._S = true;
    this.showDetailsView(a);
};
_getOrgChart.prototype.expand = function (b, a) {
    var c = this;
    b.collapsed = _getOrgChart.EXPANDED;
...
_getOrgChart.prototype.expandOrCollapse = function (a) {
    var c = this;
    var b = this.nodes[a];
    this._a2 = {
        id: a,
    ...
    if (b.collapsed == _getOrgChart.EXPANDED) {
        b.collapsed = _getOrgChart.COLLAPSED;
    } else {
        b.collapsed = _getOrgChart.EXPANDED;
    }
    this.loadFromJSON(this.nodes, true, function () {
...
_getOrgChart.prototype.moveToMostDeepChildForNode = function (b) {
    var c = _getOrgChart.util._8(this._X);
...
_getOrgChart.prototype.insertNode = function (e, b, c) {
    var a = {
        id: c,
        pid: e,
        data: b
    ...
    if (c == undefined) {
        c = _getOrgChart.util._G(this.nodes);
    }
...
_getOrgChart.prototype.removeNode = function (b) {
    var e = this;
...
_getOrgChart.prototype.updateNode = function (b, d, a) {
    var e = this;
    var c = e.nodes[b];
...
_getOrgChart.prototype._h = function (d, f, g, c, a, b) {
    var h = this.config.customize[d] && this.config.customize[d].theme ? _getOrgChart.themes[this.config.customize[d].theme] : this.theme;
    a = a == undefined ? _getOrgChart.NOT_DEFINED : a;
    var e = new _getOrgChart.node(d, f, g, c, h.size, this.config.photoFields, a, b);
    ...
    this.nodes[d] = e;
    for (label in e.data) {
        if (!_getOrgChart.util._s(this._ai, label)) {
            this._ai.push(label);
        }
    }
    return e;
};
_getOrgChart.prototype._aN = function (k, c) {
    c[0].stopPropagation();
    c[0].preventDefault();
    document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none";
    var n = _getOrgChart.util._8(this._X);
    var m = this;
    var l = this._X._v;
    var b = {
        x: c[0].clientX,
...
_getOrgChart.prototype._aJ = function (b, a) {
    if (!this.config.enableDragDrop) {
        return;
    }
    this._ak = b.getAttribute("data-node-id");
};
_getOrgChart.prototype._aU = function (b, a) {
    if (!this.config.enableDragDrop) {
        return;
    }
    this._ak = null;
};
_getOrgChart.prototype._C = function (b, a) {
    this.exportToImage();
};
_getOrgChart.prototype.exportToImage = function () {
...
_getOrgChart.prototype.load = function () {
...
_getOrgChart.prototype.loadFromJSON = function (g, q, a) {
    this._zm = 0;
    this._zj = 0;
    this._zu = new _getOrgChart.node(-1, null, null, null, 2, 2);
    if (q) {
    ...
    if (this.config.layout == _getOrgChart.MIXED_HIERARCHY_RIGHT_LINKS) {
        for (var e in this.nodes) {
            var l = this.nodes[e];
            var j = _getOrgChart.util._ap(l);
            l.l = j;
            if (j > this.maxLevel) {
                this.maxLevel = j;
            }
                ...
                for (z = 0; z < o.children.length; z++) {
                    ...
                    if (b.children.length == 0 && b != this.nodes[k] && b.displayPid == null && b.displayChildren == null) {
                        if (this.nodes[k].color == null) {
                            this.nodes[k].color = _getOrgChart.util._4(this.config.color);
                        }
...
_getOrgChart.prototype.loadFromHTMLTable = function (c) {
    var d = c.rows[0];
    var g = [];
...
_getOrgChart.prototype.loadFromXML = function (c) {
    var a = this;
    var b = [];
...
_getOrgChart.prototype.loadFromXMLDocument = function (b) {
    var a = [];
    var c = _getOrgChart.util._zG(b);
    this._aA = 0;
    this._aQ(c, null, true, a);
    this.loadFromJSON(a);
};
_getOrgChart.prototype._aQ = function (m, l, d, h) {
    var a = this;
    if (m.nodeType == 1) {
...
_getOrgChart.prototype._y = function (d, b) {
    var a = b[0];
    ...
    if (b[0].touches.length == 2) {
        this._a8.dragStart = null;
        this._p = null;
        this._za = _getOrgChart.util._zq(this._X._v, a);
    }
};
_getOrgChart.prototype._b = function (j, d) {
    var c = d[0];
    c.preventDefault();
    if (d[0].touches.length == 1) {
        ...
        if (this._a8.dragStart) {
            ...
            this._X._t.style.cursor = "move";
            var l = _getOrgChart.util._8(this._X);
            var m = l[2] / this._a0;
            var f = l[3] / this._a9;
            var a = m > f ? m : f;
    ...
    if (d[0].touches.length == 2) {
        var b = _getOrgChart.util._zq(this._X._v, d[0]);
        var k = 1 + (b - this._za) / (this._za / 100) / 100;
        var i = _getOrgChart.util._zz(this._X._v, d[0]);
        this.zoom(k, null, i);
        this._za = b;
    }
};
_getOrgChart.prototype._g = function (d, b) {
    var a = b[0];
    var c = new Date().getTime();
};
_getOrgChart.prototype._a1 = function (i, c) {
    var b = c[0];
    this._aH(i, c);
    this._aK(i, c);
    var h = new Date().getTime();
...
_getOrgChart.prototype._aP = function (c, b) {
    var a = b[0];
    a.preventDefault();
};
_getOrgChart.prototype._aL = function (c, b) {
    var a = b[0];
